      ...
      <DialogContent>
        <Grid container spacing={2} mb="12px">
          ...
          <Grid
            ...
            textAlign="left"
          >
            {(appointmentData.clientData && appointmentData.clientData.name) ||
              "-"}
          </Grid>
          <Grid
            item
          ...
          <Grid
            ...
            textAlign="left"
          >
            {(appointmentData.clientData && appointmentData.clientData.email) ||
              "-"}
          </Grid>
          <Grid
            item
          ...
          >
            {(appointmentData.clientData &&
              appointmentData.clientData.contact) ||
              "-"}
          </Grid>
          <Grid
            item
          ...
          <Grid
            ...
            textAlign="left"
          >
            {(appointmentData.service && appointmentData.service.name) ||
            ...
            onclick={() =>
              loc(
                appointmentData.room
                  ...
                  : `/message/${user.id}-${
                      (appointmentData.clientData &&
                        appointmentData.clientData._id) ||
                      ""
                    }`
              )
            }
          />
          {appointmentData.clientData && appointmentData.clientData._id && (
            <CustomButton
              name={
                savedClinet.find(
                  (f) =>
                    f.userId &&
                    f.userId._id &&
                    f.userId._id === appointmentData.clientData._id
                )
                  ? "Remove Client"
                  : "Save Client"
              }
