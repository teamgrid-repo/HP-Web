  ...
  return (
    <div>
      ...
      <div className={classes.desc}>
        ...
        (“Website”) and services provided in connection with access and use of
        the Website (“Services”), and constitute a legally binding agreement
        between you, a HIPAA Entity (“You” or “Your”), and Her PLAN, a product
        of the Susan B. Anthony List, Inc. (collectively “Her PLAN” or “We”).
        These Terms inform You of Your rights and the rights held by Her PLAN in
        relation to Your use of the Website and provision of Services. By
        connecting and/or accessing and/or using, the Website and/or providing
        your Services, You expressly confirm Your agreement to these Terms and
        ...
        <ul>
          ...
          <li>
            ...
            connection with your duties as: (i) a HIPAA-covered entity or (ii)
            an employee, administrator, agent or advisor who has been authorized
            by a HIPAA-covered entity to access the Website and provide the
            Services and, in accessing and using the Website and/or Services,
            You are binding such HIPAA-covered entity to these Terms;
          </li>
          <li>
            If you are an employee, administrator, agent, advisor or contractor
            of a HIPAA-covered entity. You are authorized to bind your
            HIPAA-covered entity to these Terms in connection with Your use of
            the Website and/or provision of Services, and, accordingly, You
            agree that such HIPAA-covered entity is bound to these Terms;
          </li>

          <li>
            If you are a HIPAA Entity, you are authorized to use the Website and
            provide the Services in connections with Your obligations as a HIPAA
            Entity;
          </li>
          <li>
            Your registered users will access the Website and use the Services
            using the registration process (in the Section below titled, USER
            REGISTRATION AND HER PLAN COMMUNICATIONS), and You have provided
            accurate and complete information to your users concerning the same;
          </li>
          <li>
      ...
      <div className={classes.desc}>
        ...
        EMERGENCY OR IN CASE OF AN URGENT HEALTHCARE NEED. IF SOMEONE WITH WHOM
        YOU ARE WORKING HAS AN EMERGENCY OR URGENT MEDICAL NEED, HE OR SHE
      ...
      <div className={classes.desc}>
        ...
        including without limitation, any of the material, documents or other
      ...
      <div className={classes.desc}>
        ...
        <br />
        <br />
        <b>Your Rights, Obligations.</b> Subject to Your compliance with these
        Terms, Her PLAN grants You a personal, non-exclusive, non-transferable,
        ...
        in connection with the provision to women and families facing challenges
        associated with pregnancy, of life-affirming assistance, support and
        treatment, including without limitation, health care; care associated
        with well-being, recovery and mental health; prenatal diagnosis; and
        pregnancy care, along with collaboration with Service providers and
        other health care providers to meet the needs of such women and families
        (collectively, the “Purposes ”). You acknowledge and agree that it is
        Your sole responsibility to ensure that You have the appropriate
        training and licensure and authority to perform the work that You are
        doing and to provide the services to individuals that you are providing,
        and agree that while the Website and Services are designed to provide
        information, it is Your sole responsibility to make decisions regarding
        the work You do and, if You are a health care provider, the services you
        provide to individuals in your care, always exercising your own clinical
        judgment, and to ensure that the same is properly documented in the
        medical records you maintain.
        <br />
        <br />
        You may download, copy and use information, documents, content and
        materials purposely made available by Her PLAN for downloading from the
        Website, provided that: (1) You do not remove any proprietary notice
        language in all copies of such documents; (2) You do not add, delete,
        distort, misrepresent or add representations to, any content provided by
        Her PLAN; and (3) You use such information and materials only for the
        Purposes. You may not copy, reproduce or resell, without the express
        written authorization of Her PLAN, any manuals, materials, documents or
        portions thereof that are purchased from Her PLAN.
      </div>
      ...
      <div className={classes.desc}>
        ...
        individuals, health care , health care practices or Her PLAN providers
        using this Website. We use the information You provide to provide
        certain Services, including maintaining user lists, maintaining a
        directory with an online map search function as a resource for Her PLAN
        providers and health care providers and health care practices seeking to
        refer women for further assistance, maintaining statistics, providing
        You with Her PLAN publications and/or providing You with other
        information, education and services. You agree to provide complete,
        accurate and up-to-date information during the registration process and
        to update such information as necessary to ensure that it remains
      ...
      <div className={classes.desc}>
        ...
        communication to be discontinued by deactivating Your Account. You may
        access, adjust, remove Your personal information, or deactivate Your
        Account by contacting Her PLAN at
        <a href="mailto:info@herplan.org">info@herplan.org</a>.
      </div>

      <div className={classes.title}>NO MEDICAL ADVICE</div>
      <div className={classes.desc}>
        The Her PLAN Website features a variety of content on issues related to
        ...
        in this Website are for general audiences only. Health care providers
        are typically best able to evaluate whether or not a specific health
      ...
      <div className={classes.title}>HIPAA COMPLIANCE</div>
      <div className={classes.desc}>
        As a HIPAA Entity, You are required to comply with HIPAA at all times in
        offering Your Services through the Website and Services. Our Website and
        Services are compliant with all applicable obligations under HIPAA. To
        the extent We operate as a Business Associate to You, the terms of the
        Business Associate Agreement will apply. To the extent there is a
        conflict between the terms of the Business Associate Agreement and these
        Terms, the Business Associate Agreement will govern.
      </div>
      ...
      <div className={classes.desc}>
        ...
        third parties, including credit card processing companies and other
        businesses, to assist in processing online fees/donations. Her PLAN also
        may use third parties to assist in providing the Website or Services.
        Any such third party is an authorized third party under Your
        authorization above.
        <br />
        <br />
        <b> Sponsors and Advertisers.</b>The Website may contain information
        on/for third parties. Information about entities, individuals or
        organizations on the Website does not imply endorsement by Her PLAN or
        its affiliates of the advertised product, company or service. Her PLAN
        does not explicitly or implicitly endorse third parties in exchange for
        advertising, and advertising does not influence our editorial content,
        products, or services. Her PLAN does not make any representation as to
        the accuracy or suitability of any of the information contained in these
        advertisements or sites and does not accept, or have, any responsibility
        or liability for the conduct or content of those advertisements and
        sites and the offerings made by the third parties. Her PLAN recommends
        that users of the Website do their due diligence before engaging a
        vendor or service provider. Her PLAN has complete discretion to
        determine the acceptability of any and all postings on its website,
        including sponsored post contributors, if any.
        <br />
        <br />
        <b> Postings and Grants.</b> The Website may contain posts by third
        parties. Posting by such third parties on the Website does not imply
        endorsement by Her PLAN or its affiliates of the company posting, or the
        product, information or service. Her PLAN does not explicitly or
        implicitly endorse third parties in exchange for advertising and does
        not accept remuneration for postings.
        <br />
        <br />
        ...
        individuals or organizations outside of Her PLAN. These links are not an
        endorsement of these external websites or the values or opinions
      ...
      <div className={classes.desc}>
        ...
        these Terms, or other standards or guidelines established by Her PLAN
        from time to time. Your rights under these Terms will terminate
        automatically or otherwise cease to be eﬀective without notice from Her
        PLAN if You fail to comply with any term(s) of these Terms. You also
        agree that any violation by You of these Terms will constitute an
        unlawful and unfair business practice, and will cause irreparable harm
        to Her PLAN, for which monetary damages would be inadequate, and You
        consent to Her PLAN obtaining any injunctive or equitable relief that
        Her PLAN deems necessary or appropriate in such circumstances. These
        remedies are in addition to any other remedies Her PLAN may have at law
        or in equity.
        <br />
        <br />
...
export default ProviderUserWithHippa;
