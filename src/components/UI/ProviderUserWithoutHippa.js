...
const ProviderUserWithoutHippa = () => {
  ...
  return (
    <div>
      ...
      <div className={classes.desc}>
        ...
        (“Website”) are between you (“You” or “Your”), as an organization
        providing certain services through the Website (“Services”), and Her
        PLAN, a product of the Susan B. Anthony List Education Fund, Inc.
        (collectively “Her PLAN” or “We”). These Terms inform You of Your rights
        and the rights held by Her PLAN in relation to Your use of the Website
        and provision of Services. By connecting and/or accessing and/or using,
        the Website and/or providing your Services, You expressly confirm Your
        agreement to these Terms and also acknowledge and agree that:
        <ul>
          <li>
          ...
          <li>
            You are authorized to use the Website and provide the Services in
            connection with Your duties as an employee, agent, advisor or
            contractor of an organization that is a Service Provider who/which
            has been authorized by such Service Provider to access the Website
            and provide the Services and, in accessing and using the Website
            and/or Services, You are binding Your Service Provider to these
            Terms;
          </li>
          <li>
            If you are an employee, agent, advisor or contractor of an
            organization that is a Service Provider, You are authorized to bind
            your Service Provider to these Terms in connection with Your use of
            the Website and/or provision of Services, and, accordingly, You
            agree to bind such Service Provider to these Terms;
          </li>

          <li>
            If you are a Service Provider, You are authorized to use the Website
            and provide the Services in connection with Your duties as a Service
            Provider;
          </li>
          <li>
            It is Your sole responsibility to ensure that You have the
            appropriate training and licensure and authority to perform the
            Services, and agree that while the Website is designed to provide
            information, it is Your sole responsibility to make decisions
            regarding the Services you provide, and to ensure that the same is
            properly documented where appropriate;
          </li>
          <li>
            You will first obtain authorization from any individual prior to
            contacting a health care provider, health care group or another
            Service Provider (defined below) about such individual; and
          </li>
          <li>
        ...
        THESE TERMS, YOU ARE NOT PERMITTED TO USE THE WEBSITE OR PROVIDE THE
        SERVICES, AND SHALL NOT CONNECT TO, ACCESS OR USE THE WEBSITE OR PROVIDE
        THE SERVICES. Your connection to, access or use of the Website and/or
        provision of Services are deemed to be Your acceptance of these Terms.
      </div>

      <div className={classes.title}>CHANGES</div>
      <div className={classes.desc}>
        We may change these Terms from time to time at our discretion and any
        changes to these Terms will be posted on the Website and become
        ...
        provision of the Services after We make changes is deemed to be
        acceptance of the changes, so please check these Terms periodically for
        updates.
      </div>
      <div className={classes.title}>NOTICE OF CLASS WAIVER</div>
      <div className={classes.desc}>
        THESE TERMS REQUIRE YOUR WAIVER OF JURY TRIAL AND CLASS ACTION LAWSUITS,
        AND LIMIT HER PLAN’S LIABILITY IN DISPUTES. SEE BELOW FOR FURTHER
        DETAIL.
      </div>
      ...
      <div className={classes.desc}>
        ...
        <br />
        <br />A <b>“Service Provider”</b> is an organization in a community,
        ...
        children.
        <br />
        <br />A <b>“HIPAA Entity”</b> is an entity that has identified as a
        HIPAA-covered entity, and therefore is also providing healthcare
        services.
        <br />
        <br />
        Her PLAN Providers may include providers not listed on the Website.
      </div>

      <div className={classes.title}>MEDICAL EMERGENCIES</div>
      <div className={classes.desc}>
        THE WEBSITE AND THE SERVICES ARE NOT INTENDED FOR USE, AND YOU SHOULD
        NOT USE THEM, OR RECOMMEND USE OF THEM IN ANY WAY, IN A MEDICAL
        EMERGENCY OR IN CASE OF AN URGENT HEALTHCARE NEED. IF YOU HAVE, OR
        SOMEONE WITH WHOM YOU ARE WORKING HAS, AN EMERGENCY OR URGENT MEDICAL
        NEED, YOU, OR SHE OR HE, SHOULD GET CARE FROM AN EMERGENCY DEPARTMENT,
      ...
      <div className={classes.desc}>
        ...
        <a href="mailto:info@herplan.org" target={"_blank"}>
          info@herplan.org
        </a>
        for permission to reproduce or make copies of any part of the Website,
        including without limitation, any of the information, documents (such as
        directories, guidebooks, etc.) and other content and materials on the
        Website.
      </div>
      ...
      <div className={classes.desc}>
        ...
        (excluding logos, trade names, trademarks and contact information of
        Service Providers), and all updates and derivative works of any of the
        foregoing, and all rights, title and interest in and to, and all
        intellectual property rights therein, are owned by Her PLAN, its
        licensors and/or its affiliates. The structure, design, selection,
        expression, "look and feel" and arrangement organization and code of the
        Website also are owned, controlled or licensed by or to Her PLAN, and
        ...
        only for Assistance Purposes and/or Community Purposes and only in a
        non-commercial, educational and informational manner (all of the
        foregoing, collectively, the “Purposes”). You may download, copy and use
        information, documents (such as directories, guidebooks, etc.) and other
        content and materials made available by Her PLAN for downloading from
        the Website, provided that: (1) You do not remove any proprietary notice
        or proprietary language from any copies of such information, documents,
        content or materials; (2) You do not add, delete, distort, misrepresent
        or add representations or other information to, any such information,
        documents, content or materials; and (3) You use such information,
        documents, content and materials only for the Purposes. You may not
        copy, reproduce or resell, without the prior express written
        authorization of Her PLAN, any information, documents, content,
        materials or portions thereof that are downloaded from the Website or
        otherwise provided by Her PLAN. [You may copy, reproduce, but not sell,
        the information, documents, content and materials and portions thereof
        that are downloadable from the Website for any non-commercial purpose of
        educating or providing help to the public and/or individuals facing a
        pregnancy decision, so long as Your intent is to further the
        life-affirming mission of Her PLAN.] Further, You acknowledge and agree
        that You will not disclose to anyone other than a General User or
        another Service Provider or HIPAA covered entity listed on the Website
        any information about any Assistance Provider or listed on the Website,
        unless such information is available in public areas of our website
        (I.e. those areas not requiring registration to access.)
      </div>
      ...
      <div className={classes.desc}>
        ...
        <ul>
          <li>
            Your use of the Website or Services for any illegal purposes and You
          ...
          <li>
            Your attempt to take any action and/or use any method that would
            allow data to be retrieved from the Website, including data
            scraping, data harvesting, Web crawling or any other automatic
            device, program or operation enabling any direct or indirect
            migration and/or duplication of the data or Services accessible from
            the Website;
          </li>
          <li>
          ...
          <li>
            ...
            PLAN, its affiliates, Service Providers, partners or any user of the
      ...
      <div className={classes.title}>
        USER REGISTRATION AND HER PLAN COMMUNICATIONS
      </div>
      <div className={classes.desc}>
        To use certain portions of this Website, You may be asked to complete a
        ...
        individuals or Service Providers or health care providers to use the
        Website. You agree to provide complete, accurate and up-to-date
        information during the registration process and to update such
        information as necessary to ensure that it remains complete, accurate
        and up-to-date.
        <br />
        <br />
      ...
      <div className={classes.desc}>
        If You create Your Account, Her PLAN may occasionally send You
        information on resources, services, news and other issues. If You
        register to receive a Her PLAN publication, We will ask for Your contact
        information to send You that publication. You may request for any such
        communications with Her PLAN to be discontinued by deactivating Your
        Account, or by emailing{" "}
        <a href="mailto:info@herplan.org">info@herplan.org</a>. You may
        unsubscribe to email. by choosing the “unsubscribe” option. We also
        provide the means for You to contact and communicate and interact with
        Her PLAN, and with other Service Providers and HIPAA covered entities.
        You acknowledge and agree that You must first obtain authorization from
        an individual prior to contacting other Service Providers or health care
        providers or health care practices about such individual. You also
        acknowledge and agree that Your communications or interaction with
        health care providers or health care practices may be subject to Health
        Insurance Portability and Accountability Act (“HIPAA”) and applicable
        state law, and that such health care providers and health care practices
        are responsible for providing You notices and information about their
        and Your compliance with the foregoing. We do not control these health
        care providers or health care practices. If You have any questions about
        these matters, You should contact the responsible health care provider
        or health care practice.
        <br />
        <br />
        You may access, adjust, remove Your personal information, or deactivate
        Your Account by contacting H Her PLAN at{" "}
        <a href="mailto:info@herplan.org">info@herplan.org</a>.
      </div>
      ...
      <div className={classes.desc}>
        ...
        professional medical advice. You are advised to advise any person with
        whom you are working to seek advice from his or her personal medical
        physician on issues related to his or her health. The issues and content
        in this Website are for general audiences only. Your physician is
        typically best able to evaluate whether or not a specific health
        suggestion or potential course of treatment is best for a person.
        <br />
        <br />
        ...
        <ul>
          <li>
            ...
            license or other authority to do any of the foregoing; and
          </li>
          <li>
        ...
        If You think a person with whom You are working may be having a medical
        emergency, You should immediately call 911.
      </div>
      ...
      <div className={classes.desc}>
        ...
        Services, and You should advise any person with whom You are working of
        the foregoing.
      </div>
      ...
      <div className={classes.desc}>
        ...
        securing of your personal information. <br />
        <br />
        <b> RECORDS RETENTION</b>
        Her PLAN does not store data on Your behalf, nor does it retain records
        concerning your interaction with individuals through the Website and
        Services. You are solely responsible for all information gathering,
        storage, and transfer of information when you use the Website or provide
        your Services
      </div>

      <div className={classes.title}>
        UPDATES, THIRD PARTY ASSISTANCE, SPONSORS AND ADVERTISERS, AND LINKS
      </div>
      <div className={classes.desc}>
        <b> Updates and Other Rights.</b> Her PLAN may, in its sole discretion,
        provide, all updates, supplements, add-on components, features, or other
        ...
        <br />
        <br />
        <b> Third Party Assistance.</b> Her PLAN may use third parties to assist
        in providing the Website or Services. Any such third party is an
        authorized third party under Your authorization above.
        <br />
        <br />
        <b> Sponsors and Advertisers.</b>The Website may contain information
        on/for third parties. Advertising on the Website does not imply
        endorsement by Her PLAN or its affiliates of the advertised product,
        company or service. Her PLAN does not explicitly or implicitly endorse
        third parties in exchange for advertising, and advertising does not
        influence our editorial content, products, or services. Her PLAN does
        not make any representation as to the accuracy or suitability of any of
        the information contained in these advertisements or sites and does not
        accept, or have, any responsibility or liability for the conduct or
        content of those advertisements and sites and the offerings made by the
        third parties. Her PLAN recommends that users of the Website do their
        due diligence before engaging a vendor or service provider. Her PLAN has
        complete discretion to determine the acceptability of any and all
        advertisements and advertisers, including sponsored post contributors.
        Postings and Grants. The Website may contain posts by third parties.
        Posting by such third parties on the Website does not imply endorsement
        by Her PLAN or its affiliates of the company posting, or the product,
        information or service. Her PLAN does not explicitly or implicitly
        endorse third parties in exchange for advertising and does not accept
        remuneration for postings.
        <br />
        <br />
        ...
        individuals or organizations outside of Her PLAN. The provision of these
        links is neither an explicit nor implicit endorsement by Her PLAN of
        these external websites or of the respective organizations or
        individuals sponsoring such external websites, or of the products,
        services or information offered on such external websites, or of the
        values or opinions expressed therein. Her PLAN does not control or
        guarantee such websites, and expressly disclaims any representations or
        warranties, implied or express, regarding such websites’ respective
        content and offerings, and the accuracy or appropriateness of such
        content and offerings, and their respective positions on abortion, and
        does not accept, or have, any responsibility or liability for the
        conduct or content of such external websites or their respective
        offerings, and the values and/or opinions expressed therein. Should You
        visit these external websites, You will be under the terms of service
        and privacy policy maintained by the sites/owners of such external
        websites. Her PLAN has no responsibility for Your choices regarding Your
        access and/or use of such external websites, the products, services or
        information offered on such external websites, or of the values or
      ...
      <div className={classes.desc}>
        ...
        submitting responses to any surveys provided to You PLAN or on our
        behalf. You acknowledge and agree that You are responsible for such
      ...
      <div className={classes.desc}>
        ...
        these Terms or other standards or guidelines which may be associated
        with Your use of the Website or Services as established by Her PLAN from
        time to time. Notwithstanding the foregoing, Your rights under these
        Terms will terminate automatically or otherwise cease to be eﬀective
        without notice from Her PLAN if You fail to comply with any term(s) of
        these Terms. You also agree that any violation by You of these Terms
        will constitute an unlawful and unfair business practice, and will cause
        irreparable harm to Her PLAN, for which monetary damages would be
        inadequate, and You consent to Her PLAN obtaining any injunctive or
        equitable relief that Her PLAN deems necessary or appropriate in such
        circumstances. These remedies are in addition to any other remedies Her
        PLAN may have at law or in equity.
        <br />
        <br />
        ...
        <br />
        <br />
        If Her PLAN suspends Your Account due to Your actual or suspected breach
        of the Terms, such suspension will continue until the suspected breach
        is cured or otherwise resolved to Her PLAN’S satisfaction.
        <br />
        <br />
      ...
      <div className={classes.desc}>
        ...
        <br />
        <br />
        <b> Indemnification.</b> You agree to, and if You are an employee,
        agent, advisor or contractor of a Service Provider, You agree that such
        Service Provider will jointly and severally with You, defend, indemnify,
        and hold harmless HER PLAN and its affiliates and their respective
        officers, directors, employees and agents, and successors and assigns
        from and against any and all demands, losses, liabilities, claims,
        expenses, and costs (including, but not limited to, fees, costs and
        other expenses of attorneys and expert witnesses) arising out of or
        related to: (i) Your use of the Website or the Services; (2) Your
        violation of these Terms; or (3) Your fraud, willful misconduct or gross
        negligence.
        <br />
        <br />
...
export default ProviderUserWithoutHippa;
